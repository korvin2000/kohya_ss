...
def apply_gor_loss(loss, unet_module:torch.nn.Module, num_groups:int, regularization_type:str, 
    ...
    """
    reg_loss = calc_group_reg_loss(
        unet_module, num_groups=num_groups, reg_type=regularization_type, names_to_reg=name_to_regularize,
