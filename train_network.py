...
class NetworkTrainer:
    ...
    def cache_text_encoder_outputs_if_needed(self, args, accelerator, unet, vae, tokenizers, text_encoders,
                                             data_loader, weight_dtype):
        ...
        for epoch in range(num_train_epochs):
                    ...
                    if args.save_every_n_steps is not None and global_step % args.save_every_n_steps == 0:
                        ...
                        if accelerator.is_main_process:
                            ...
                            save_model(ckpt_name,
                                       accelerator.unwrap_model(network), global_step, epoch)
                            if args.save_state:
            ...
            if args.save_every_n_epochs is not None:
                ...
                if is_main_process and saving:
                    ...
                    save_model(ckpt_name, accelerator.unwrap_model(network),
                               global_step, epoch + 1)
