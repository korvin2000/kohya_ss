...
class NetworkTrainer:
    ...
    # TODO 他のスクリプトと共通化する
    def generate_step_logs(self, args: argparse.Namespace, current_loss, avr_loss, lr_scheduler, keys_scaled=None, mean_norm=None,
                           maximum_norm=None):
    ...
    def train(self, args):
        ...
        if args.base_weights is not None:
            ...
            for i, weight_path in enumerate(args.base_weights):
                ...
                module, weights_sd = network_module.create_network_from_weights(multiplier, weight_path, vae,
        ...
        if args.gor_regularization:
            modules_to_regularize = precalculate_modules_to_check(network.unet_loras, args.gor_name_to_regularize,
                                                                  args.gor_regularize_fc_layers)
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                with accelerator.accumulate(network):
                    ...
                    if args.gor_regularization:  # required args : gor_num_groups : int, gor_regularization_type: str, gor_name_to_regularize: str, gor_regularize_fc_layers: bool, gor_ortho_decay: float
                        loss = apply_gor_loss_precalculated(loss, modules_to_regularize, args.gor_num_groups,
                                                            args.gor_regularization_type, args.gor_ortho_decay)
